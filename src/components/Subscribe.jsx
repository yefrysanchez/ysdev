      ...
      <div className="flex justify-center mt-4">
        <div className="mb-3 xl:w-[500px]">
          <div className="relative mb-4 flex w-full flex-wrap items-stretch">
            ...
            />
            <button
              className="relative z-[2] rounded-r border-2 border-black px-6 py-2 text-xs font-medium uppercase text-black transition duration-150 ease-in-out hover:bg-black hover:text-white  focus:outline-none focus:ring-0"
              type="button"
              id="button-addon3"
              data-te-ripple-init
            >
